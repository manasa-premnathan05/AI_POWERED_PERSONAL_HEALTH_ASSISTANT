...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmt->execute([$doctor_name, $specialty, $appointment_date, $location, $notes, $appointment_id, $user_id]);
...
@media (max-width: 768px) {
    ...
    <!-- Same head content as add_appointment.php -->
</head>
<body>
        ...
        <div class="main-content">
            <div class="appointment-form-container">
                ...
                <div class="form-header">
                    ...
                    <p>Update your medical visit details</p>
                </div>
                ...
                <form action="edit_appointment.php?id=<?php echo $appointment_id; ?>" method="post">
                    <div class="form-group float-label">
                        <input type="text" id="doctor_name" name="doctor_name" class="form-control" 
                               value="<?php echo htmlspecialchars($appointment['doctor_name']); ?>" placeholder=" " required>
                        <label for="doctor_name">Doctor's Name</label>
                    </div>
                    
                    <div class="form-group float-label">
                        <input type="text" id="specialty" name="specialty" class="form-control" 
                               value="<?php echo htmlspecialchars($appointment['specialty']); ?>" placeholder=" " required>
                    ...
                    <div class="form-group float-label">
                        <input type="text" id="location" name="location" class="form-control" 
                               value="<?php echo htmlspecialchars($appointment['location']); ?>" placeholder=" " required>
    ...
    <!-- Same script as add_appointment.php -->
</body>
</html>